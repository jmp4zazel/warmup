...
// Code by: https://github.com/mohabouz/CPP-AES-OpenSSL-Encrypt
// Can't be bothered to convert this in modern C++
...
string aesEncrypt ( string plainText, string pass )
{
  ...
  */
  ...
  int cipherSize =
      encrypt ( plainTextBytes, strlen ( ( char * )plainTextBytes ),
                ( unsigned char * )keyStr.c_str (), ( unsigned char * )iv.c_str (), cipher );
...
string aesDecrypt ( string cipher, string pass )
{
  ...
  decrypt ( cipherBytes, strlen ( ( char * )cipherBytes ), ( unsigned char * )keyStr.c_str (),
            ( unsigned char * )iv.c_str (), plainTextBytes );
